  ...
  )
{
  ...
  if (HMainEditor.MouseSupported) {
    ...
    if (HBufferImageMouseNeedRefresh) {
      ...
      //
      FRow = HBufferImage.LowVisibleRow + HBufferImageBackupVar.MousePosition.Row - TEXT_START_ROW;
      ...
      PrintAt (
        HBufferImageBackupVar.MousePosition.Column - 1,
      ...
      // clear the old mouse position
      //
      FRow = HBufferImage.LowVisibleRow + HBufferImage.MousePosition.Row - TEXT_START_ROW;
      ...
      PrintAt (
        HBufferImage.MousePosition.Column - 1,
...
--*/
{
  if (FileRow >= HBufferImage.LowVisibleRow && FileRow <= HBufferImage.LowVisibleRow + NUM_TEXT_ROWS - 1) {
    return TRUE;
  }
...
--*/
{
  ...
  if (Under) {
    ...
    if (Above) {
      ...
      //
      if (NewFilePosRow < (HBufferImage.DisplayPosition.Row - TEXT_START_ROW + 1)) {
  ...
  HBufferImage.LowVisibleRow = HBufferImage.BufferPosition.Row - (HBufferImage.DisplayPosition.Row - TEXT_START_ROW);
